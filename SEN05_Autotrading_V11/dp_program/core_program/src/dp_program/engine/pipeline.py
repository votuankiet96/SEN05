...
# Chỉ backfill dùng fetch_and_store() để ghi SQL; live giờ đẩy thẳng lên
# Redis (xem engine/live.py) và không đụng SQL. validate_candles() là hàm
# thuần duy nhất còn được cả live lẫn backfill dùng chung.
