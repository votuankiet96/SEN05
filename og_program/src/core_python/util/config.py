"""Shared market metadata for core_python.

This module is intentionally source-agnostic: no SQL, Flask, or file system
side effects — just symbols, timeframes, and lookup helpers shared by the
data/strategy/chart/export pipeline in `core_python`.
"""
