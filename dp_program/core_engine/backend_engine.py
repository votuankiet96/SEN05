...
from core_engine.utis_support.health import cleanup_old_runtime_files, collect_health
from core_engine.reporting.activity import log_activity
from core_engine.reporting.logging_setup import setup_logger
from core_engine.reporting.logfmt import operation_line
from core_engine.reporting.notifications import notify_backend_event, notify_historical_event, notify_live_event, tg_flush
...
class BackendSupervisor:
    ...
    def start_live(self, *, reason: str = "auto_start") -> None:
        ...
        self._spawn(
            self.live,
            [sys.executable, "-m", "core_engine.live_fetching"],
            BACKEND_LIVE_STDOUT_LOG,
        )
        self._safe_notify(
            notify_live_event,
    ...
    def start_historical(self, *, reason: str = "schedule", schedule_slot: str | None = None) -> None:
        ...
        command = [
            sys.executable,
            "-m",
            "core_engine.historical_pulling",
            "--mode",
