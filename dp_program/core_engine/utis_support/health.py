...
from core_engine.utis_support.live_runtime import playwright_browser_status
...
def collect_data_health(*, lookback_days: int | None = None) -> dict[str, Any]:
    ...
    """
    from core_engine.data_processing.db_connector import get_internal_gaps, get_latest_bars
    from core_engine.data_processing.warehouse_connection import get_connection
    from core_engine.utis_support.historical_runtime import find_hole_pairs, find_stale_pairs
