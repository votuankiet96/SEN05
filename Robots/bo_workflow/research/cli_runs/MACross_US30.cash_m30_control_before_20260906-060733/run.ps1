...
$algoPath = 'C:\Users\Administrator\Documents\cAlgo\Sources\Robots\research\diagnostics\minimal-safety-2026-09-06\before\MA Cross.algo'
...
$cliArgs = @('backtest', $algoPath, $paramsPath,
    '--start=01/01/2026 00:00', '--end=01/02/2026', '--data-mode=Ticks',
    ...
    '--period=m30', '--full-access', "--report-json=$reportPath")
...
$summary = [ordered]@{
    ...
    RequestedStartUTC='2026-01-01 00:00:00'; RequestedEndUTC='2026-02-01 00:00:00'
