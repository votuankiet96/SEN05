...
$cliArgs = @('backtest', $algoPath, $paramsPath,
    '--start=01/01/2026 00:00', '--end=07/01/2026 23:59', '--data-mode=Ticks',
...
try {
    while ($true) {
        ...
        if (((Get-Date) - $started).TotalMinutes -ge 10) { $timedOut = $true; break }
...
$summary = [ordered]@{
    ...
    RequestedStartUTC='2026-01-01 00:00:00'; RequestedEndUTC='2026-01-07 23:59:00'
