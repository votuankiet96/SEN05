# MA Cross / BTCUSD / M20 -- tick backtest 01/01-28/02/2026
...
- Net P/L: 331.11  (ROI 3.31%) ; Profit factor 1.19
- Closed trades: 120  (43 win / 77 loss) ; elapsed ~118s

## Signal -> execution reconciliation (log <-> events.json <-> OnStop summary: 100% match)
- Signals in window: 122 ; placed OK: 120 ; reject/fail: 0
- same-direction-skipped = 2 ; reversed = 8 ; margin-capped = 120 ; margin-blocked = 0
- Outcome breakdown: MarginCapped=112 Reversal+MarginCapped=8 SkippedSameDirection=2
...
Native copy from GUI instance: 5c1a3cf1-967d-4713-b9d7-9db8f8cc53ca.
Signal-by-signal file: research/reports/macross-BTCUSD-m20-jan-feb2026-signal-trace-2026-09-05.csv
