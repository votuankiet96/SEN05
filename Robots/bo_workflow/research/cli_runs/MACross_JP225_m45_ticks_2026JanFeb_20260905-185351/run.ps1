...
$algoPath = 'C:\Users\Administrator\Documents\cAlgo\Sources\Robots\MA Cross.algo'
...
$cliArgs = @('backtest', $algoPath, $paramsPath,
    '--start=01/01/2026 00:00', '--end=28/02/2026 23:59', '--data-mode=Ticks',
    '--balance=10000', '--ctid=votuankiet96@gmail.com',
    '--pwd-file=C:\Users\Administrator\.ctrader-cli-pwd.txt',
    '--account=7563609', '--broker=FTMO Platform', "--symbol=$symbol",
    "--period=$period", '--full-access', "--report-json=$reportPath")
...
try {
    while ($true) {
        ...
        if (((Get-Date) - $started).TotalMinutes -ge 30) { $timedOut = $true; break }
...
$summary = [ordered]@{
    ...
    RequestedStartUTC='2026-01-01 00:00:00'; RequestedEndUTC='2026-02-28 23:59:00'
