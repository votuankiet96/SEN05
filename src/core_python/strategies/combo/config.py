...
# Khung thời gian được gợi ý mặc định trên dashboard/CLI cho Combo — không
# phải giới hạn cứng, TF_MINUTES vẫn cho phép chạy TF khác nếu chủ động chọn.
RECOMMENDED_TIMEFRAMES: tuple[str, ...] = ("H1", "H2", "H3", "H4")
