...
Mô tả:
    ...
    Chuỗi kết nối dùng chung với core_python.util.settings.sql_connection_string()
...
Phụ thuộc ngoài:
    pyodbc, core_python.util.settings (sql_connection_string()).
"""
...
from core_python.util.settings import sql_connection_string
