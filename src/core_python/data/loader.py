...
from core_python.util.config import TF_MINUTES, get_symbol
...
def load_range(
    ...
    *,
    ...
    prehistory. ``tail_bars`` optionally extends after ``end`` for callers that
    need future context. Callers should trim strategy outputs back to the
