...
Mô tả:
    Kết nối SQL Server qua og_core.data.db_connector, truy vấn bảng
...
Phụ thuộc ngoài:
    og_core.data.db_connector.get_connection() — kết nối pyodbc đến SQL Server.
"""
...
from og_core.data.db_connector import get_connection
