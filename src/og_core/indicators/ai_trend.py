"""
AI Trend Navigator indicator calculations for og_core.

This ports the public TradingView Pine indicator "AI Trend Navigator"
by Zeiierman to the lowercase OHLCV convention used in og_core.
...
from og_core.indicators.core import atr, ema, sma
