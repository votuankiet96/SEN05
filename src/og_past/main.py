"""Historical dashboard entry point for OG Past.
...
Run:
    python -m og_past.main
    python -m og_past.main --port 9000
    python -m og_past.main --debug
"""
...
from og_past.chart.server import DEFAULT_HOST, DEFAULT_PORT, run
...
def _parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Run the OG Past historical dashboard.")
...
def main() -> int:
    ...
    """
    args = _parse_args()
    print(f"OG Past dashboard: http://{args.host}:{args.port}")
