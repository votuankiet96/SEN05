...
name (`from core_engine.core.live.state import _stats`) because callers mutate
...
must go through the module object (`from core_engine.core.live import state`
...
# module must go through `core_engine.core.live.state` (the module object),
# not `from core_engine.core.live.state import spool_full_pause`.
