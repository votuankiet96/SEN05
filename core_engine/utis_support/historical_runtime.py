...
from core_engine.data_processing.db_connector import get_internal_gaps
from core_engine.reporting.historical_reporting import historical_scan_summary_block, log_historical_block
