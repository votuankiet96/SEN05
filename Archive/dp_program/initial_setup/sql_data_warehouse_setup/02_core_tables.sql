/* ============================================================
   ...
   PURPOSE:
     Step 2 of 5 — Create all core/dimension/fact tables and seed reference data.
   ...
   WHAT THIS FILE CREATES (in plain English):
     ...
     1. THREE "LOOKUP" TABLES (dimensions):
        ...
        a) Dim_Symbol    — "Which instrument?" (seeded by 06_seed_symbols.sql)
   ...
   NOTE: DWH.Dim_Symbol is created by this file and seeded by
         06_seed_symbols.sql from the runtime instrument list.
