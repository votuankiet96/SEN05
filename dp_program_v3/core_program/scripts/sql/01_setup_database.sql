/* ============================================================
   ...
   PURPOSE:
     Step 1 of 6 — Create the database and all schemas.
     ...
     WHAT THIS FILE DOES IN PLAIN ENGLISH:
       ...
       2. Creates 2 "schemas" inside the database — these are like
...
/* ============================================================
   ...
   THE TWO SCHEMAS AND THEIR ROLES:
     ...
     DWH (Data WareHouse)
       ...
       Python runtime reads DWH.Fact_OHLCV directly.
