...
- V3 dùng OS file lock tại `runtime/run/engine.lock`, không dùng
  `SEN.ActiveTask`.
- Process chết phải tự giải phóng file handle của lock.
- Lệnh ghi thủ công phải bị từ chối khi service đang giữ lock.
