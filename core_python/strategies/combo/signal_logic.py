# =============================================================================
# strategies/combo/signal_logic.py  —  Signal logic riêng cho Combo v2
# =============================================================================
"""Toàn bộ logic phát hiện tín hiệu của chiến lược Combo v2.

Module này gom lại từ 3 file cũ:
- core/_scan_shared.py      → build_raw_signal_masks, resolve_trade_hit,
                               build_signal_record
- core/reversal_scanner.py  → scan_signals_reversal
- core/backtest_engine.py   → add_combo_indicators, detect_combo_signals,
                               session_mask
