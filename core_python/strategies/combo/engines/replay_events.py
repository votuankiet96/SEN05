"""Optional replay event helpers for Combo execution engines."""
...
def replay_events_to_frame(events: list[BacktestReplayEvent] | list[dict[str, Any]]) -> pd.DataFrame:
    """Convert engine replay event objects to a DataFrame."""
...
__all__ = ["BacktestReplayEvent", "direction_to_side", "emit_replay_event", "replay_events_to_frame"]
