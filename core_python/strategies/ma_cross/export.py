"""Export MA Cross signal/order plans for external cTrader validation."""
...
def build_ctrader_signal_export(
    ...
    *,
    ...
    """Build a cTrader-ready CSV frame from the exact MA Cross signal logic."""
        ...
        rows.append(
            {
                ...
                "comment": "ma_cross|execute_at=next_open",
            }
        )
