"""Market, broker, and instrument definitions used by backtests.

This module is the single shared source for symbol specs, broker profiles, cost
defaults, lot rounding, and config audits. Strategy modules may overlay their
own parameters, but execution metadata should come from here.
"""
...
# -----------------------------------------------------------------------------
# Instrument and broker profile configuration
# -----------------------------------------------------------------------------
